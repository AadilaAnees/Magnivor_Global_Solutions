...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Magnivor Global Solutions — Accounting, Tax, CFO & Advisory" },
      {
        name: "description",
        content:
          "Magnivor Global Solutions is a Sri Lanka–based international consulting firm delivering accounting, taxation, CFO advisory, BPO and economic intelligence services.",
      },
      { name: "author", content: "Magnivor Global Solutions" },
      { property: "og:title", content: "Magnivor Global Solutions" },
      {
        property: "og:description",
        content:
          "Global insight. Strategic clarity. Financial precision. Accounting, tax, CFO advisory, BPO and economic intelligence.",
      },
